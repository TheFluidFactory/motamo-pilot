(() => {
  ...
  M.ui.collectDom = function collectDom() {
    M.ui.dom = {
      ...
      questionInteractionCard: document.querySelector('#question-interaction-card'),
      questionInteraction: document.querySelector('#question-interaction'),
      answerAreaLabel: document.querySelector('#answer-area-label'),
      inputMessage: document.querySelector('#input-message'),
      gameKeyboard: document.querySelector('#game-keyboard'),
      gamePlayLayout: document.querySelector('#game-play-layout'),
      ...
      finalAlphabetRack: document.querySelector('#final-alphabet-rack'),
      finalCollectedCount: document.querySelector('#final-collected-count'),
      finalCollectedEmpty: document.querySelector('#final-collected-empty'),
